...
INSERT INTO `table_college` (`id`, `name`, `city`, `state`, `address`) VALUES
(1, 'Chandigarh University', 429, 18, 'Chandigarh University, mohali, punjab'),
(2, 'Ranchi University', 214, 34, 'Ranchi University, main road, Ranchi'),
(3, 'IIT Delhi', 116, 25, 'IIT Delhi Main Rd, IIT Campus, Hauz Khas, New Delhi, Delhi 110016'),
(4, 'IIT Kanpur', 556, 23, 'Kalyanpur, Kanpur, Uttar Pradesh 208016'),
(5, 'IIT Bombay', 329, 12, 'Main Gate Rd, IIT Area, Powai, Mumbai, Maharashtra 400076');
...
ALTER TABLE `table_college`
  ADD PRIMARY KEY (`id`),
  ADD KEY `state_foreign_key` (`state`),
  ADD KEY `city_foreign_key` (`city`);
...
--
ALTER TABLE `table_college`
  ADD CONSTRAINT `city_foreign_key` FOREIGN KEY (`city`) REFERENCES `cities` (`id`),
  ADD CONSTRAINT `state_foreign_key` FOREIGN KEY (`state`) REFERENCES `states` (`id`);
